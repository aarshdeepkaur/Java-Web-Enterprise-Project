...
import com.mycompany.spritearshdeep1.util.PaginationHelper;
...
public class SpriteController implements Serializable {
    ...
    @EJB
    private com.mycompany.spritearshdeep1.SpriteFacade ejbFacade;
...
private Locale locale;
 public SpriteController() {
    ...
    @PostConstruct
    public void init() {
        locale = FacesContext.getCurrentInstance().getExternalContext().getRequestLocale(); //Set to default at first
    }
    public Locale getLocale() {
        return locale;
    }
    public String getLanguage() {
        return locale.getLanguage(); //get the language for the we crawlers – retuns lang for the current locale
    }
